const projectData = [
  {
    ...
    description:
      "A full stack forum app based on a social media platform allows users to participate in discussions, share information, and connect with like-minded individuals in a community-driven environment. User can perform all actions like seraching, posting, commenting, liking, sharing etc.",
    techStack:
  ...
  },
  {
    ...
    src: `./images/projectPreviews/middle-man.png`,
    description:
  ...
  },
  {
    ...
    src: `./images/projectPreviews/apni_dukan.png`,
    description:
  ...
  },
  {
    id: 5,
    name: "Urban(clone)",
    src: `./images/projectPreviews/urban.png`,
    description:
